...
@section('content')
    ...
    <div class="bg-primary rounded-b-4xl p-8 flex justify-between">
        <div>
            <div class="flex items-center gap-3">
                ...
                <h1 class="font-monstserrat text-white text-[42px] font-bold">Tasks</h1>
            </div>
            <h3 class="font-montserrat text-white/80">Don't forget to do your tasks! :)</h3>
        </div>
    ...
    <div class="p-8 pt-6">
        <div class="flex justify-between items-center">
            <h1 class="font-montserrat text-text-primary text-3xl font-bold">Tasks</h1>
