        ...
        <div class="w-full lg:w-1/2 p-5 lg:px-12 flex flex-col justify-center relative z-10 h-full animate-reveal delay-100 opacity-0">
            <div class="w-full max-w-md mx-auto">
                ...
                <form action="/forgot" method="POST" class="space-y-4">
                    ...
                    <button
                        type="submit"
                        class="text-text-contrast w-full bg-primary cursor-pointer hover:bg-primary-hover font-bold py-2.5 md:py-2 rounded-xl transition-all shadow-md active:scale-95 text-sm md:text-base">
