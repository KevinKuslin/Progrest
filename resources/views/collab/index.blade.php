...
@section('content')
    <div x-data="collabModal()">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-6 px-8 py-6">
            ...
            <div class="rounded-3xl bg-background shadow-sm flex flex-col p-4 gap-1 items-center">
                <div class="flex gap-3">
                    ...
                    <p class="text-text-primary text-3xl font-montserrat font-semibold">{{ $activeCollabsCount }}</p>
                </div>
            ...
            <div class="rounded-3xl bg-background shadow-sm flex flex-col p-4 gap-1 items-center">
                <div class="flex gap-3">
                    ...
                    <p class="text-text-primary text-3xl font-montserrat font-semibold">{{ $completedCollabsCount }}</p>
                </div>
            ...
            <div class="rounded-3xl bg-background shadow-sm flex flex-col p-4 gap-1 items-center col-span-2 md:col-span-1">
                <div class="flex gap-3">
                    ...
                    <p class="text-text-primary text-3xl font-montserrat font-semibold">{{ $pointsGained }}</p>
                </div>
        ...
        @include('collab.partials.collaboration-modal')
        
        {{-- Mark Active Collab Task as Completed --}}
        @include('collab.partials.complete-modal')
        
        {{-- Show Submission Detail Modal --}}
        @include('collab.partials.submission-modal')
